...
| OpenClaw-style HTTP runtime | preview | host-signed preview | Host-specific verification exists as a per-host override above the stub baseline, but broader V3/V4 claims still stay preview until the host matrix says otherwise |
