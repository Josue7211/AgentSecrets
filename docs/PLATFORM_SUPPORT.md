...
This document is the V4 platform-support source of truth.
...
| OpenClaw-style HTTP runtime | preview | not certified | Contract exists, no shipped V4 identity claim |
| Claude / Codex / arbitrary external runtimes | unsupported | not certified | Do not claim V4 platform trust tier |
