...
- If the host also claims transcript or log redaction, define sink classification and fail-closed behavior explicitly. Use [docs/REDACTION_POLICY.md](docs/REDACTION_POLICY.md) as the current repo-owned example.
...
- Treat OpenClaw as preview until it has its own host-specific evidence in [docs/SUPPORTED_HOSTS.md](docs/SUPPORTED_HOSTS.md).
